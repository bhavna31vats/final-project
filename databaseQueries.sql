...
CREATE TABLE books (
	...
	CONSTRAINT pk_product_id PRIMARY KEY (id),
 	CONSTRAINT fk_product_category_id FOREIGN KEY categoryId REFERENCES categories (id),
	CONSTRAINT fk_product_supplier_id FOREIGN KEY REFERENCES user_detail(id),	
);	
